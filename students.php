...
<body>
    ...
    <section id="navigation">
        ...
        <div class="row">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Reported Students</h4>
                    <a href="reported.php" class="btn btn-primary">Click me</a>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Not-Reported Students</h4>
                    <a href="not-reported.php" class="btn btn-primary">Click me</a>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="Students_Form.php" class="btn btn-primary">Click me</a>
                </div>
            </div>
        </div>
        </div>
